...
<head>
    ...
    <title>Voitures en Location</title>
    <style>
...
<body>
    <header class="header" style="background-color: cadetblue;">
        <h1>Liste des voitures disponibles pour la location :</h1>
...
<?php
    ...
    if ($resultat->num_rows > 0) {
        // Afficher les données de chaque voiture
        ...
        echo "Aucune voiture disponible pour la location.";
    }
